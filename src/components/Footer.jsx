    ...
    return (
        ...
        <div className="container bg-blue-100 mx-auto px-4">
            ...
            <div className="w-full border lg:w-6/12 px-4">
                ...
                <button className="bg-red-400 text-lightBlue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button"/>
                    <button className="bg-blue-200 text-lightBlue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button"/>
                   <button className="bg-pink-200 text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button"/>
                   <button className="bg-orange-300 text-blueGray-800 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button"/>
                </div>
            </div>
